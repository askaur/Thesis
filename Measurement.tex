...
For inclusive 2-jet events sufficient data are available up to \httwo $\leq$ 2000 GeV, while for inclusive 3-jet events and the ratio \rations, the accessible range is limited to \httwo $\leq$ 1680 GeV.
