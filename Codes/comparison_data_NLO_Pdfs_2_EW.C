...
void comparison_data_NLO_Pdfs_2_EW(){
  setTDRStyle();
  ...
  TFile *fNLO_Pdfs =  TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Final_Plots_PAS/RootFiles/Rebin_NLO_PDFS_HT_2_150_2.root");
  
  TFile *fNLO_Unc = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Theory_Unc_2.root");
  
  TFile *fNLO_Unc_copy = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Theory_Unc_2_copy.root");
  ...
  TH1D *hCT10 = (TH1D*)fNLO_Pdfs->Get("CT10_2");
  TH1D *hMSTW =  (TH1D*)fNLO_Pdfs->Get("MSTW_2");
  TH1D *hNNPDF =  (TH1D*)fNLO_Pdfs->Get("NNPDF_2");
  TH1D *hNLO_Unc_Up =  (TH1D*)fNLO_Unc->Get("Theory_Unc_Up");
  TH1D *hNLO_Unc_Up_2 =  (TH1D*)fNLO_Unc_copy->Get("Theory_Unc_Up");  
  TH1D *hNLO_Unc_Down =  (TH1D*)fNLO_Unc->Get("Theory_Unc_Down");
  TH1D *hNLO_Unc_Down_2 =  (TH1D*)fNLO_Unc_copy->Get("Theory_Unc_Down");
  ...
  TH1D *hNP_2 =  (TH1D*)fNP_2->Get("Central Value");
  ...
  TH1D *hData_CT10_ratio = new TH1D("Data_CT10_ratio_2","Data_CT10_ratio_2",arr_size-1,bins);
  hData_CT10_ratio->Sumw2();
  
  TH1D *hData_CT10_ratio_err = new TH1D("Data_CT10_ratio_2_err","Data_CT10_ratio_2_err",arr_size-1,bins);
  ...
  for (int i = 1; i <= arr_size-1  ; i++)
    {
     if ( hCT10->GetBinContent(i) == 0.0 || hNP_2->GetBinContent(i) == 0.0 )
     double data_bin_ratio = 1.;
     else
     double data_bin_ratio = hData_2->GetBinContent(i)/(hCT10->GetBinContent(i)*hNP_2->GetBinContent(i)*hEW_2->GetBinContent(i));
     //cout<<" Bin : "<<i<<" Con : "<<hData_2->GetBinContent(i)<<endl;
     hData_CT10_ratio->SetBinContent(i,data_bin_ratio);
     hData_CT10_ratio_err->SetBinContent(i,data_bin_ratio);     
     
     if (hData_2->GetBinContent(i) == 0.0 )
      double stat_err = 1.;
      else
 ...
 for (int i = 1; i <= arr_size-1  ; i++)
    { 
      double np_factor_2 = hData_CT10_ratio->GetBinContent(i);
       //cout<<" Bin : "<<hNP_2->GetBinLowEdge(i)<<" Factor : "<< np_factor_2 <<endl;
 }


  //hData_CT10_ratio->Print("all");
  hMSTW->Divide(hCT10);
  hNNPDF->Divide(hCT10);
  ...
  hNLO_Unc_Down_2->SetLineColor(kRed); 
  hNLO_Unc_Down_2->SetLineWidth(1);
  hNLO_Unc_Down_2->SetLineStyle(3); 
  ...
  hNLO_Unc_Up->Add(hNLO_Unc_Down_2,-1); 
  hs_th->Add(hNLO_Unc_Up);
  
  hData_CT10_ratio->GetXaxis()->SetRangeUser(300.0,2000.0);
  hData_CT10_ratio_err->GetXaxis()->SetRangeUser(300.0,2000.0);
  hMSTW->GetXaxis()->SetRangeUser(300.0,2000.0);
  hNNPDF->GetXaxis()->SetRangeUser(300.0,2000.0);
  hExp_Unc_Up->GetXaxis()->SetRangeUser(300.0,2000.0);
  hExp_Unc_Down->GetXaxis()->SetRangeUser(300.0,2000.0);
  ...
  hs_stack_1->GetXaxis()->SetRange(22,54);
  ...
  hData_CT10_ratio->GetYaxis()->SetRangeUser(0.5,2.5);
  ...
  legend1->AddEntry(hData_CT10_ratio,"Data/(NP #otimes EW)","pel");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Comparison_data_NLO_Pdfs_2_EW.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Comparison_data_NLO_Pdfs_2_EW.pdf"); 
