...
void Final_NP_Corr_3(){
  setTDRStyle();
   
  TFile *fNP = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Monte/NP_Corr/RootFiles_HT_2_150/NP_Corr_HT_2_150.root");
      
  TH1D *hNP_pythia =  (TH1D*)fNP->Get("NP_Corr_HT_2_150_3");
  TH1D *hNP_herwig =  (TH1D*)fNP->Get("GenMCJetHt_2_3");
  TH1D *hNP_powheg =  (TH1D*)fNP->Get("NP_Corr_HT_2_150_3_powheg_S1");
  ...
  f_pythia->SetParameter(0,29.0983);
  f_pythia->SetParameter(1,-1.05791);
  f_pythia->SetParameter(2,1.00433);
  
  f_herwig->SetParameter(0,284.29);
  f_herwig->SetParameter(1,-1.68126);
  f_herwig->SetParameter(2,1.01876);
  
  f_powheg->SetParameter(0,379.329);
  f_powheg->SetParameter(1,-1.55413);
  f_powheg->SetParameter(2,1.00201);
  ...
  */ 
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Final_NP_Corr_3.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Final_NP_Corr_3.pdf");
