...
#include "TH1.h"
#include "TH1F.h"
void extrapolate_sigma_value_res_2_crystal_range(){
  setTDRStyle(); 
  ...
  hexp->GetXaxis()->SetRangeUser(1000.,2000.); 
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Extrapolate_Sigma_Value_Res_2_crystal_range.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Extrapolate_Sigma_Value_Res_2_crystal_range.pdf");
}
