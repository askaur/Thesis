...
void comparison_data_MC_samples_3_Pow(){
  setTDRStyle();
  ...
  TH1D *hData_2 = (TH1D*)fdata_2->Get("Data_3_new");
  TH1D *hMad  = (TH1D*)fmad->Get("Hadd_GenMCJetHT_2_150_3_nopileup_New");
  TH1D *hpythia  = (TH1D*)fpythia->Get("jet/GenMCJetHt_2_3");
  TH1D *hherwig  = (TH1D*)fherwig->Get("jet/GenMCJetHt_2_3");
  TH1D *hpowheg_S1  = (TH1D*)fpowheg->Get("GenMCJetHt_2_3_S1");
  TH1D *hpowheg_M1  = (TH1D*)fpowheg->Get("GenMCJetHt_2_3_M1");  
  ...
  for (int i = 1; i <= arr_size-1  ; i++)
    {
     ...
     double data_bin_ratio = hData_2->GetBinContent(i)/hpowheg_S1->GetBinContent(i);
 ...
 // hherwig->Scale(847881020.0/180709224.0);    
  ...
  hpythia->GetXaxis()->SetRangeUser(300.0,1680.0);
  hherwig_new->GetXaxis()->SetRangeUser(300.0,1680.0);
  hExp_Unc_Up->GetXaxis()->SetRangeUser(300.0,1680.0);
  hpowheg_M1->GetXaxis()->SetRangeUser(300.0,1680.0);
  hMad->GetXaxis()->SetRangeUser(300.0,1680.0);  
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Comparison_data_MC_samples_3_Pow.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Comparison_data_MC_samples_3_Pow.pdf"); 
