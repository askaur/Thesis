...
void Sensitivity_double_ratio_32_MM(){
  setTDRStyle();
  ...
  for (int i = 1.; i <= nbinsx; i++)
    ...
    for (int i = 1.; i <= nbinsx; i++)
    {
     ...
     double ratio = data_ratio/(h3_120->GetBinContent(i)*np_ratio);  //data/(theory*np)
  ...
  h3_108->Divide(h3_120);   
  h3_109->Divide(h3_120);  
  h3_110->Divide(h3_120);
  h3_111->Divide(h3_120);
  h3_112->Divide(h3_120);
  h3_113->Divide(h3_120);
  h3_114->Divide(h3_120);
  h3_115->Divide(h3_120);
  h3_116->Divide(h3_120);
  h3_117->Divide(h3_120);
  h3_118->Divide(h3_120);
  h3_119->Divide(h3_120);
  h3_121->Divide(h3_120);
  h3_122->Divide(h3_120);
  h3_123->Divide(h3_120);
  h3_124->Divide(h3_120);
  h3_125->Divide(h3_120);  
  h3_126->Divide(h3_120); 
  h3_127->Divide(h3_120);  
  h3_128->Divide(h3_120);   
     
  h3_120->Divide(h3_120);
  ...
  h3_108->GetYaxis()->SetRangeUser(0.5,2.0);  
  ...
  h3_108->GetYaxis()->SetTitle("Ratio to NLO (MMHT2014)");
  h3_108->GetYaxis()->SetTitleOffset(1.04);
  ...
  h3_108->GetYaxis()->SetNdivisions(508);
  ...
  legend1->AddEntry(h3_108,"MMHT2014 #alpha_{s}(M_{z}) = 0.108 - Min. Value","l");
  legend1->AddEntry(h3_120,"MMHT2014 #alpha_{s}(M_{z}) = 0.120","l");
  legend1->AddEntry(h3_128,"MMHT2014 #alpha_{s}(M_{z}) = 0.128 - Max. Value","l");
  legend1->Draw();
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Sensitivity_double_ratio_32_MMHT2014.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Sensitivity_double_ratio_32_MMHT2014.pdf");
