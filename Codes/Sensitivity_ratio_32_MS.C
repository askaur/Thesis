...
void Sensitivity_ratio_32_MS(){
  ...
  h3_110->GetYaxis()->SetRangeUser(0.05,0.35);  
  ...
  h3_110->GetYaxis()->SetTitle("#it{R}_{32}");
  h3_110->GetYaxis()->SetTitleOffset(1.15);
  ...
  h3_110->GetYaxis()->SetNdivisions(507);
  ...
  legend1->AddEntry(h3_110,"MSTW #alpha_{s} (M_{z}) = 0.110 - Min. Value","l");
  legend1->AddEntry(h3_1202,"MSTW #alpha_{s} (M_{z}) = 0.1202","l");
  legend1->AddEntry(h3_130,"MSTW #alpha_{s} (M_{z}) = 0.130 - Max. Value","l");
  legend1->Draw();
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Sensitivity_ratio_32_MSTW2008.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Sensitivity_ratio_32_MSTW2008.pdf");
