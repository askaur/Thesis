...
void nvertices_2(){
  ...
  TH1F *h2_11 = dynamic_cast<TH1*>(f1->Get("jet/trupuMC_weight"));
  TH1F *h2_12 = dynamic_cast<TH1*>(f2->Get("jet/trupuMC_weight"));
  TH1F *h2_13 = dynamic_cast<TH1*>(f3->Get("jet/trupuMC_weight"));
  TH1F *h2_14 = dynamic_cast<TH1*>(f4->Get("jet/trupuMC_weight"));
  ...
  hrat1_11->GetYaxis()->SetRangeUser(0.9,1.1);
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Nvertices_weight.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Nvertices_weight.pdf");
  c->Write();
