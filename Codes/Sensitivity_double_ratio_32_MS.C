...
void Sensitivity_double_ratio_32_MS(){
  setTDRStyle();
  
  TFile *fdata_2 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Sensitivity/MSTW2008/RootFiles/Sensitivity_2_MSTW2008.root");
  TFile *fdata_3 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Sensitivity/MSTW2008/RootFiles/Sensitivity_3_MSTW2008.root");
  ...
  TH1D *h2_1202 =  (TH1D*)fdata_2->Get("h2_1202");
  ...
  TH1D *h2_129 =  (TH1D*)fdata_2->Get("h2_129");
  TH1D *h2_130 =  (TH1D*)fdata_2->Get("h2_130");
  
  TH1D *h3_1202 =  (TH1D*)fdata_3->Get("h3_1202");
  ...
  TH1D *h3_129 =  (TH1D*)fdata_3->Get("h3_129");
  TH1D *h3_130 =  (TH1D*)fdata_3->Get("h3_130");
 
  
  h3_1202->Divide(h2_1202);
  ...
  h3_129->Divide(h2_129);
  h3_130->Divide(h2_130);
  ...
  for (int i = 1.; i <= nbinsx; i++)
    {
      ...
      double cont_110 = h3_110->GetBinContent(i);
      double cont_111 = h3_111->GetBinContent(i);
      
      if (cont_111 < cont_110) cout<<" Min. not ok for bin"<<i<<" "<<h3_112->GetBinLowEdge(i)<<"-"<<h3_112->GetBinLowEdge(i+1)<<endl;
 
      double cont_129 = h3_129->GetBinContent(i);
      double cont_130 = h3_130->GetBinContent(i);
      
      if (cont_129 > cont_130) cout<<" Max. not ok for bin"<<i<<" "<<h3_112->GetBinLowEdge(i)<<"-"<<h3_112->GetBinLowEdge(i+1)<<endl;
    }
    ...
    for (int i = 1.; i <= nbinsx; i++)
    {
     ...
     double ratio = data_ratio/(h3_1202->GetBinContent(i)*np_ratio);  //data/(theory*np)
  ...
  h3_110->Divide(h3_1202);
  h3_111->Divide(h3_1202);
  h3_112->Divide(h3_1202);
  h3_113->Divide(h3_1202);
  h3_114->Divide(h3_1202);
  h3_115->Divide(h3_1202);
  h3_116->Divide(h3_1202);
  h3_117->Divide(h3_1202);
  h3_118->Divide(h3_1202);
  h3_119->Divide(h3_1202);
  h3_120->Divide(h3_1202);
  h3_121->Divide(h3_1202);
  h3_122->Divide(h3_1202);
  h3_123->Divide(h3_1202);
  h3_124->Divide(h3_1202);
  h3_125->Divide(h3_1202);  
  h3_126->Divide(h3_1202); 
  h3_127->Divide(h3_1202);  
  h3_128->Divide(h3_1202);   
  h3_129->Divide(h3_1202);   
  h3_130->Divide(h3_1202);  
   
  h3_1202->Divide(h3_1202);
  
  h3_1202->SetLineStyle(1);
  
  h3_110->SetLineStyle(11);
  ...
  h3_128->SetLineStyle(2);   
  h3_129->SetLineStyle(2);   
  h3_130->SetLineStyle(11);  
  
  h3_1202->SetLineColor(kBlack);
   
  h3_110->SetLineColor(kRed);
  ...
  h3_128->SetLineColor(kGray);
  h3_129->SetLineColor(kGray);
  h3_130->SetLineColor(kBlue); 
     
  h3_110->GetXaxis()->SetRangeUser(300.,1680.); 
  hdata_ratio->GetXaxis()->SetRangeUser(300.,1680.); 
  h3_110->GetYaxis()->SetRangeUser(0.5,2.0);  
  
  h3_110->SetTitle("");
  h3_110->GetXaxis()->SetTitle("#it{H}_{T,2}/2 (GeV)");
  h3_110->GetXaxis()->SetTitleOffset(1.04);
  h3_110->GetXaxis()->SetTitleSize(0.06);
  h3_110->GetXaxis()->SetMoreLogLabels();
  h3_110->GetXaxis()->SetNoExponent();
  h3_110->GetXaxis()->SetLabelSize(0.05);
  h3_110->GetXaxis()->SetLabelOffset(0.018);
  h3_110->GetXaxis()->SetTickLength(0.03);
  
  h3_110->GetYaxis()->SetTitle("Ratio to NLO (MSTW2008)");
  h3_110->GetYaxis()->SetTitleOffset(1.04);
  h3_110->GetYaxis()->SetTitleSize(0.06);
  h3_110->GetYaxis()->SetLabelSize(0.05);
  h3_110->GetYaxis()->SetTickLength(0.03);
  h3_110->GetYaxis()->SetLabelOffset(0.008);
  h3_110->GetYaxis()->SetNdivisions(508);
  h3_110->GetYaxis()->SetDecimals(4);
  ...
  h3_129->Draw("histsame][");
  h3_130->Draw("histsame][");
  
  h3_1202->Draw("histsame][");
  ...
  legend1->AddEntry(h3_110,"MSTW2008 #alpha_{s}(M_{z}) = 0.110 - Min. Value","l");
  legend1->AddEntry(h3_1202,"MSTW2008 #alpha_{s}(M_{z}) = 0.1202","l");
  legend1->AddEntry(h3_130,"MSTW2008 #alpha_{s}(M_{z}) = 0.130 - Max. Value","l");
  legend1->Draw();
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Sensitivity_double_ratio_32_MSTW2008.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Sensitivity_double_ratio_32_MSTW2008.pdf");
