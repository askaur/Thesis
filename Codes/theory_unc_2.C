...
void theory_unc_2(){
  ...
  TFile *fUnc = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Final_Plots_PAS/RootFiles/Rebin_NLO_PDFS_HT_2_150_2.root");
  TFile *fNP = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Monte/NP_Corr/RootFiles_HT_2_150/Final_NP_Corr_2.root");
    
  TFile *file = new TFile("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Theory_Unc_2.root","RECREATE");
  //*****************************************************************
  
  TH1D *hScale_Up =  (TH1D*)fUnc->Get("Scale_Up_2");
  TH1D *hScale_Down =  (TH1D*)fUnc->Get("Scale_Down_2");
  TH1D *hPDF_Up =  (TH1D*)fUnc->Get("PDF_Up_2");
  TH1D *hPDF_Down =  (TH1D*)fUnc->Get("PDF_Down_2");
 // TH1D *hNP_Up =  (TH1D*)fNP->Get("Final NP Pythia");
 // TH1D *hNP_Down =  (TH1D*)fNP->Get("Final NP Herwig");
  ...
  hScale_Up->SetLineColor(kRed); 
  hScale_Up->SetLineWidth(2); 
  hScale_Up->SetLineStyle(11);    
  
  hScale_Down->SetLineColor(kRed); 
  hScale_Down->SetLineWidth(2); 
  hScale_Down->SetLineStyle(11);      
  ...
  hTheory_Unc_Up->GetXaxis()->SetRangeUser(300.0,2000.0);
  hTheory_Unc_Down->GetXaxis()->SetRangeUser(300.0,2000.0); 
  hScale_Up->GetXaxis()->SetRangeUser(300.0,2000.0);
  hScale_Down->GetXaxis()->SetRangeUser(300.0,2000.0);
  hPDF_Up->GetXaxis()->SetRangeUser(300.0,2000.0);
  hPDF_Down->GetXaxis()->SetRangeUser(300.0,2000.0);
  hNP_Up->GetXaxis()->SetRangeUser(300.0,2000.0);
  hNP_Down->GetXaxis()->SetRangeUser(300.0,2000.0);  
  ...
  legend1->AddEntry(hScale_Up,"Scale Uncertainty","l");
  legend1->AddEntry(hPDF_Up,"PDF Uncertainty","l");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Theory_Unc_2.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Theory_Unc_2.pdf"); 
  file->Write();  
}  
