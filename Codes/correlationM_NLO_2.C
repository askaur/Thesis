...
#include "TH1.h"
#include "TH1F.h"
void correlationM_NLO_2()
{
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/CorrelationM_NLO_2_range_ite4.root");
   
  //************************************************************************
    
  TH2D *h1_11 =  (TH2D*)f1->Get("corr_matrix");
  TH1D *h2_11 = (TH1D*)f1->Get("Measured_True");
  ...
  pt1.DrawLatex(0.16,0.95,"#font[42]{n_{j} #geq 2}");// (Iterations = 10)");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Correlation_Matrix_NLO_2_ite4.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Correlation_Matrix_NLO_2_ite4.pdf");
}
