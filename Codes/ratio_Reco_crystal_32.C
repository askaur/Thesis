double makeCanvas(TCanvas *c, TH1D *hMC_Reco, TH1D *hMC_Reco_smear, TH1D *hMC_Reco_smear_less, TString plotname, bool twojet)
{
  ...
  else legend1->AddEntry((TObject*)0,"#it{R}_{32}"," ");
...
void ratio_Reco_crystal_32(){
  ...
  hMC_Reco_3->Divide(hMC_Reco_2);  
  hMC_Gen_3->Divide(hMC_Gen_2);
  hMC_Reco_smear_3->Divide(hMC_Reco_smear_2);  
  hMC_Reco_smear_less_3->Divide(hMC_Reco_smear_less_2); 
