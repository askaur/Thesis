...
#include "TH1.h"
#include "TH1F.h"
void correlationM_NLO_ratio_32()
{
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/CorrelationM_NLO_ratio_32_ite4.root");
   
  //************************************************************************
    
  TH2D *h1_11 =  (TH2D*)f1->Get("corr_matrix2");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Correlation_Matrix_NLO_Ratio_32_ite4.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Correlation_Matrix_NLO_Ratio_32_ite4.pdf");
}
