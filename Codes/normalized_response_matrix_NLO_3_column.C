{
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Response_Matrix_NLO.root");

  //************************************************************************
    
  TH2D *h1_11 =  (TH2D*)f1->Get("Response Matrix 3");
  ...
  /*  TArrow *arrow = new TArrow(164,480.3109,164,263.9154,0.05,">");
      ...
      arrow->Draw();
  */   
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Normalized_Response_Matrix_NLO_3_column.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Normalized_Response_Matrix_NLO_3_column.pdf");
}
