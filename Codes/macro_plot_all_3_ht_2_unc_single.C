double makeCanvas (TCanvas *c1, TH1D *h_up_1, TString plotname)
{
  ...
  tex = new TLatex(282.4028,0.9189632,"300");
  tex->SetTextFont(42);
  ...
  c1->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Single/MC_Macro_Plot_All_3_HT_2_Unc_" + plotname + ".gif");
  c1->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Single/MC_Macro_Plot_All_3_HT_2_Unc_" + plotname + ".pdf");
}
...
void macro_plot_all_3_ht_2_unc_single(){
  setTDRStyle();
