...
void total_unc_all_3_NLO_add(){
  setTDRStyle();
    
  TFile *fdata_2 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Unfolding_NLO_3_funcI.root");
  ...
  TFile *fJER = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/JER_total_unc_3_NLO.root");
  TFile *fUnf = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Unfolding_unc_3.root");
  ...
  TH1D *hJECup_MC =  (TH1D*)fJEC_MC->Get("PFJetHtUp_3_unc_total");
  TH1D *hJECdown_MC =  (TH1D*)fJEC_MC->Get("PFJetHtDown_3_unc_total");
  
  TH1D *hJERup_frac =  (TH1D*)fJER->Get("JER_Total_up_3_unc_frac");
  TH1D *hJERdown_frac =  (TH1D*)fJER->Get("JER_Total_down_3_unc_frac");
  
  TH1D *hJERup =  (TH1D*)fJER->Get("JER_Total_up_3_unc");
  TH1D *hJERdown =  (TH1D*)fJER->Get("JER_Total_down_3_unc"); 
  
  TH1D *hUnfup_frac =  (TH1D*)fUnf->Get("Unfolding_unc_Up_3_frac");
  TH1D *hUnfdown_frac =  (TH1D*)fUnf->Get("Unfolding_unc_Down_3_frac");
  
  TH1D *hUnfup =  (TH1D*)fUnf->Get("Unfolding_unc_Up_3");
  TH1D *hUnfdown =  (TH1D*)fUnf->Get("Unfolding_unc_Down_3");
  ...
  */  
  ...
  hLumi->GetXaxis()->SetRangeUser(300.,1680.); 
  ...
  hTotal_up->GetXaxis()->SetRangeUser(300.,1680.); 
  hTotal_down->GetXaxis()->SetRangeUser(300.,1680.); 
  ...
  */   
  ...
  TLine *lp = new TLine(300.0,1.026,1680.0,1.026);
  lp->SetLineStyle(5);
  lp->SetLineWidth(2);
  lp->SetLineColor(kRed-3);
  lp->Draw("same");
  
  TLine *ln = new TLine(300.0,0.974,1680.0,0.974);
  ln->SetLineStyle(5);
  ln->SetLineWidth(2);
  ln->SetLineColor(kRed-3);
  ln->Draw("same");
  
  TLine *lp1 = new TLine(300.0,1.01,1680.0,1.01);
  lp1->SetLineStyle(1);
  lp1->SetLineWidth(2);
  lp1->SetLineColor(kViolet-9);
  lp1->Draw("same");
  
  TLine *ln1 = new TLine(300.0,0.99,1680.0,0.99);
  ln1->SetLineStyle(1);
  ln1->SetLineWidth(2);
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Total_unc_all_3_NLO_add.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Total_unc_all_3_NLO_add.pdf");
