...
void Sensitivity_double_ratio_32_CT10(){
  setTDRStyle();
  ...
  h3_125->Divide(h3_118);
  h3_126->Divide(h3_118);
  h3_127->Divide(h3_118);
  ...
  h3_112->GetYaxis()->SetRangeUser(0.5,2.0);  
  ...
  h3_112->GetYaxis()->SetTitle("Ratio to NLO (CT10)");
  h3_112->GetYaxis()->SetTitleOffset(1.04);
  ...
  h3_112->GetYaxis()->SetNdivisions(508);
  h3_112->GetYaxis()->SetDecimals(4);
  h3_112->GetXaxis()->SetLabelOffset(0.011);  
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Sensitivity_double_ratio_32_CT10.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Sensitivity_double_ratio_32_CT10.pdf");
