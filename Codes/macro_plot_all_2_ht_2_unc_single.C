double makeCanvas (TCanvas *c1, TH1D *h_up_1, TString plotname)
{
  ...
  h_up_1->GetXaxis()->SetRangeUser(300.,2000.);
  ...
  TLine *lp = new TLine(300.0,1,2000.0,1);
  lp->SetLineStyle(2);
  lp->SetLineWidth(1);
  ...
  c1->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Single/MC_Macro_Plot_All_2_HT_2_Unc_" + plotname + ".gif");
  c1->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Single/MC_Macro_Plot_All_2_HT_2_Unc_" + plotname + ".pdf");
}
...
void macro_plot_all_2_ht_2_unc_single(){
  setTDRStyle();
  
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Monte/NP_Corr/RootFiles_HT_2_150/JES_unc_cal_all_HT_2_150_sources_single.root");
  ...
  if (plot1)
    { 
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncAbsoluteStat"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncAbsoluteStat"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncAbsoluteScale"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncAbsoluteScale"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncAbsoluteMPFBias"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncAbsoluteMPFBias"); 
      TH1D * h_up_4 = (TH1D*)f1->Get("Ht_2_Up_2_uncFragmentation"); 
      TH1D * h_down_4 = (TH1D*)f1->Get("Ht_2_Down_2_uncFragmentation"); 
  ...
  if (plot2)
    {
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncSinglePionECAL"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncSinglePionECAL"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncSinglePionHCAL"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncSinglePionHCAL"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncFlavorQCD"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncFlavorQCD"); 
  ...
  if (plot3)
    { 
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeJEREC1"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeJEREC1"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeJEREC2"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeJEREC2"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativePtBB"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativePtBB"); 
      TH1D * h_up_4 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeJERHF"); 
      TH1D * h_down_4 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeJERHF"); 
  ...
  if (plot4)
    {
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativePtEC1"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativePtEC1"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativePtEC2"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativePtEC2"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeFSR"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeFSR");
      TH1D * h_up_4 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativePtHF"); 
      TH1D * h_down_4 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativePtHF"); 
  ...
  //------------------------------------------------------------------------------- 
      if (plot5)
    {
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeStatFSR"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeStatFSR"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeStatEC2"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeStatEC2"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncRelativeStatHF"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncRelativeStatHF"); 
  ...
  if (plot6)
    { 
      TH1D * h_up_1 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpDataMC"); 
      TH1D * h_down_1 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpDataMC"); 
      TH1D * h_up_2 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpPtRef"); 
      TH1D * h_down_2 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpPtRef"); 
      TH1D * h_up_3 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpPtBB"); 
      TH1D * h_down_3 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpPtBB"); 
      TH1D * h_up_4 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpPtEC1"); 
      TH1D * h_down_4 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpPtEC1"); 
      TH1D * h_up_5 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpPtEC2"); 
      TH1D * h_down_5 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpPtEC2"); 
      TH1D * h_up_6 = (TH1D*)f1->Get("Ht_2_Up_2_uncPileUpPtHF"); 
      TH1D * h_down_6 = (TH1D*)f1->Get("Ht_2_Down_2_uncPileUpPtHF");
