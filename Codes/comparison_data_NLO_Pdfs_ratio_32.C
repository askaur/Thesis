...
void comparison_data_NLO_Pdfs_ratio_32(){
  setTDRStyle();
  ...
  TFile *fNLO_Pdfs_2 =  TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Final_Plots_PAS/RootFiles/Rebin_NLO_PDFS_HT_2_150_2.root");
  
  TFile *fNLO_Pdfs_3 =  TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Final_Plots_PAS/RootFiles/Rebin_NLO_PDFS_HT_2_150_3.root");
      
  TFile *fNLO_Unc = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Theory_Unc_Ratio_32.root");
  
  TFile *fNLO_Unc_copy = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Theory_Unc_Ratio_32_copy.root");
  ...
  TFile *fNP = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Script_Final_Plots_PAS/RootFiles/Final_NP_Corr_Ratio_32.root");
  
  //*****************************************************************
  
  TH1D *hData = (TH1D*)fdata->Get("Unfolded_Ratio");
  TH1D *hCT10_2 =   (TH1D*)fNLO_Pdfs_2->Get("CT10_2");
  TH1D *hCT10_3 =   (TH1D*)fNLO_Pdfs_3->Get("CT10_3");  
  TH1D *hMSTW_2 =  (TH1D*)fNLO_Pdfs_2->Get("MSTW_2");
  TH1D *hMSTW_3 =  (TH1D*)fNLO_Pdfs_3->Get("MSTW_3");  
  TH1D *hNNPDF_2 =  (TH1D*)fNLO_Pdfs_2->Get("NNPDF_2");
  TH1D *hNNPDF_3 =  (TH1D*)fNLO_Pdfs_3->Get("NNPDF_3");    
  ...
  TH1D *hNP =  (TH1D*)fNP->Get("Central Value");
  ...
  TH1D *hData_CT10_ratio = new TH1D("Data_CT10_ratio","Data_CT10_ratio",arr_size-1,bins);
  hData_CT10_ratio->Sumw2();
  
  TH1D *hData_CT10_ratio_err = new TH1D("Data_CT10_ratio_err","Data_CT10_ratio_err",arr_size-1,bins);
  hData_CT10_ratio_err->Sumw2();
  
  THStack *hs_th = new THStack("hs_th","");
  
  hCT10_3->Divide(hCT10_2);
  hMSTW_3->Divide(hMSTW_2);
  hNNPDF_3->Divide(hNNPDF_2);    
     
  for (int i = 1; i <= arr_size-1  ; i++)
    {
     if ( hCT10_3->GetBinContent(i) == 0.0 || hNP->GetBinContent(i) == 0.0 )
     double data_bin_ratio = 1.;
     else
     double data_bin_ratio = hData->GetBinContent(i)/(hCT10_3->GetBinContent(i)*hNP->GetBinContent(i));
...
*/
  hMSTW_3->Divide(hCT10_3);
  hNNPDF_3->Divide(hCT10_3);
  ...
  hMSTW_3->SetMarkerColor(kOrange+4);
  hMSTW_3->SetLineColor(kOrange+4);
  hMSTW_3->SetLineWidth(2); 
  hMSTW_3->SetLineStyle(9);             
   
  hNNPDF_3->SetMarkerColor(kGreen-6);
  hNNPDF_3->SetLineColor(kGreen-6);
  hNNPDF_3->SetLineWidth(2);      
  hNNPDF_3->SetLineStyle(1);        
  ...
  hMSTW_3->GetXaxis()->SetRangeUser(300.0,1680.0);
  hNNPDF_3->GetXaxis()->SetRangeUser(300.0,1680.0);
  ...
  hData_CT10_ratio_err->SetFillColor(33);//kRed-3);
  hData_CT10_ratio_err->SetMarkerColor(33);//kRed-3);
  hData_CT10_ratio_err->SetLineColor(33);//kRed-3);
  ...
  hMSTW_3->Draw("histsame][");
  hNNPDF_3->Draw("histsame][");
  ...
  legend1->AddEntry(hMSTW_3,"MSTW2008","l");
  legend1->AddEntry(hNNPDF_3,"NNPDF2.3","l");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Comparison_data_NLO_Pdfs_ratio_32.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Comparison_data_NLO_Pdfs_ratio_32.pdf"); 
}  
