{
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Unfolding_ratio_32_range.root");

  //************************************************************************
    
  TH2D *h1_11 =  (TH2D*)f1->Get("Response Matrix ratio 3");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Normalized_Response_Matrix_NLO_ratio_32_column_3.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Normalized_Response_Matrix_NLO_ratio_32_column_3.pdf");
}
