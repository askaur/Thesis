...
void Final_NP_Corr_2(){
  setTDRStyle();
   
  TFile *fNP = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/Monte/NP_Corr/RootFiles_HT_2_150/NP_Corr_HT_2_150.root");
     
  TH1D *hNP_pythia =  (TH1D*)fNP->Get("NP_Corr_HT_2_150_2");
  TH1D *hNP_herwig =  (TH1D*)fNP->Get("GenMCJetHt_2_2");
  TH1D *hNP_powheg =  (TH1D*)fNP->Get("NP_Corr_HT_2_150_2_powheg_S1");
  ...
  double nbinsx = hNP_pythia->GetXaxis()->GetNbins();
  cout<<nbinsx<<endl;
  ...
  f_pythia->SetParameter(0,22.9887);
  f_pythia->SetParameter(1,-1.13453);
  f_pythia->SetParameter(2,1.01244);
  
  f_herwig->SetParameter(0,9.49641);
  f_herwig->SetParameter(1,-1.1121);
  f_herwig->SetParameter(2,1.01379);
  
  f_powheg->SetParameter(0,30.9202);
  f_powheg->SetParameter(1,-1.15154);
  f_powheg->SetParameter(2,0.99256);
  ...
  */ 
  ...
  h_center->GetXaxis()->SetRangeUser(300.,2000.);    
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Final_NP_Corr_2.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Final_NP_Corr_2.pdf");
