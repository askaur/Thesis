...
#include "TH1.h"
#include "TH1F.h"
void extrapolate_theory_3_HT_2_150_funcII()
{
  setTDRStyle();
  ...
  TH1D *h1 = (TH1D*)f->Get("NLO cross_section 3_new"); 
  ...
  for (double i = 1.; i <= nbinsx; i++)
    {
      ...
      double y = (2.03735e+30)*pow(1-(xt/4000),52.0071)*pow(10,(g(xt,51.8054,1)+g(xt,42.1957,2)+g(xt,18.9018,3)+g(xt,4.54748,4)+g(xt,0.456058,5)));
      hTrue->SetBinContent(i,y);
    }

  f1->SetParameter(0,2.03735e+30);
  f1->SetParameter(1,51.8054);
  f1->SetParameter(2,42.1957);
  f1->SetParameter(3,18.9018);
  f1->SetParameter(4,4.54748);
  f1->SetParameter(5,0.456058);
  f1->SetParameter(6,52.0071);
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Extrapolate_Theory_3_HT_2_150_funcII.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Extrapolate_Theory_3_HT_2_150_funcII.pdf");
  c->Draw();
}
