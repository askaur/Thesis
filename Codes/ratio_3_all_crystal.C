...
#include "TH1.h"
#include "TH1F.h"
void ratio_3_all_crystal(){
  setTDRStyle(); 
   
  TFile *f1 = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Unfolding_NLO_3_funcI.root");
   
  TFile *f1_less = TFile::Open("/home/anter/Desktop/Analysis_8_HT_2/NLO/Final_Unfolding/Rootfile_NLO_HT_2_150/Unfolding_NLO_3_less_funcI.root");
  ...
  TH1D *hMC_Reco  = (TH1D*)f_gen->Get("jet/PFMCJetHt_2_3");
  
 TH1D *hMC_Reco_smear  = (TH1D*)f_gen->Get("jet/GenMCJetHt_2_smeared_3");
  
  TH1D *hMC_Reco_smear_less  = (TH1D*)f_gen->Get("jet/GenMCJetHt_2_smeared_3_70");
      
  TH1D *hMC_Gen  = (TH1D*)f_gen->Get("jet/GenMCJetHt_2_3");
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Ratio_all_3_crystal.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Ratio_all_3_crystal.pdf");
