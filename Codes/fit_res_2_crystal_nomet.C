...
void fit_res_2_crystal_nomet(){
  ...
  TFile *file = new TFile("/home/anter/Desktop/Analysis_8_HT_2/Monte/Madgraph/Resolution/New_Gen_50/RootFiles_HT_2_150/Fit_Res_2_final_crystal_nomet.root","RECREATE");
  ...
  sprintf(hname, "Hadd_Resolution_2_genbin_250-275_nomet");
  ...
  */
  ...
  sprintf(histname, "Fit_Res_2_final_crystal_genbin_250-275");
  h1->SetName(histname);
