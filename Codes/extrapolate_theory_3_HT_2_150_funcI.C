...
#include "TH1.h"
#include "TH1F.h"
void extrapolate_theory_3_HT_2_150_funcI()
{
  setTDRStyle();
  ...
  TF1 *f1 = new TF1("f1",function.Data(),300,2000);
  
  // 300-2000
  f1->SetParameter(0,1.28801e+16);
  f1->SetParameter(1,5.7734);
  f1->SetParameter(2,10.581);
  f1->SetParameter(3,637.424);
  ...
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Gifs/Extrapolate_Theory_3_HT_2_150_funcI.gif");
  c->SaveAs("/home/anter/Desktop/Analysis_8_HT_2/Thesis_Plots/Pdfs/Extrapolate_Theory_3_HT_2_150_funcI.pdf");
  c->Draw();
}
