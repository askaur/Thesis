...
\begin{tikzpicture}[x=1.2cm, y=1.2cm]
  ...
  \draw [brace] (-0.5,.8) -- (0.49,.8) node[toplabel]         {standard matter};
  \draw [brace] (0.52,.8)  -- (2.49,.8) node[toplabel]         {unstable matter};
  \draw [brace] (2.52,.8)  -- (4.49,.8) node[toplabel]          {force carriers};
  \draw [brace] (4.52,.8)  -- (5.49,.8) node[toplabel]       {Goldstone\\bosons};
  \draw [brace] (5.52,.8)  -- (7,.8)   node[toplabel] {outside\\standard model};
