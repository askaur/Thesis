...
\end{align*}
%\begin{center}
\hspace{-3mm}\includegraphics[scale=0.9]{/home/anter/Desktop/Thesis/Figures/New/JEC.pdf}\\
\vspace{3mm}
\begin{itemize}
...
\hspace{4mm}
\includegraphics[scale = 0.25]{Plots_HT_2_150/Total_unc_all_3_NLO_add.pdf} \\
\end{center}
\vspace{-2mm}
...
\vspace{-1mm}
\begin{center}
\includegraphics[scale = 0.25]{Plots_HT_2_150/Theory_Unc_2.pdf}%
\hspace{4mm}
\includegraphics[scale = 0.25]{Plots_HT_2_150/Theory_Unc_3.pdf} \\
\end{center}
\vspace{-3mm}
\begin{minipage}[tbp]{0.4\textwidth}
\vspace{-6mm}
...
\vspace{-6mm}
\begin{center}
\includegraphics[scale = 0.24]{Plots_HT_2_150/Sensitivity_ratio_32_CT10_only.pdf}
\end{center}
\end{minipage}
...
\end{itemize}
\hspace{-5.3mm}
\includegraphics[scale = 0.215]{Plots_HT_2_150/Comparison_data_NLO_Pdfs_2_EW.pdf}%
\includegraphics[scale = 0.215]{Plots_HT_2_150/Comparison_data_NLO_Pdfs_3.pdf}%
...
\vspace{1mm}
\begin{center}
\includegraphics[scale=0.55]{Plots_HT_2_150/Running_alphas_8TeV_R32_edited.pdf}
\end{center}
\end{frame}
...
\begin{center}
\begin{itemize}
\item {\scriptsize A measurement of the inclusive 2-jet (3-jet) event cross sections has been presented in a range of $0.3 < \httwot < 2.0$ TeV ($0.3 < \httwot < 1.68$ TeV) for the average \pt of the two leading jets at central rapidity of $|$y$|$ $<$ 2.5
\vspace{0.5mm}
...
\tri
\begin{itemize}
\item {\tiny Well described by calculations at NLO in pQCD complemented with NP corrections that are important at low \httwot \\}
\end{itemize}
\ball
\vspace{0.5mm}
...
\tri
\begin{itemize}
\item {\tiny Performed fits of \alpsmz from differential inclusive 2-jet and inclusive 3-jet event cross-sections separately and in combined fit as well as ratio \ratio, in the range in \httwot of 0.3 TeV up to 1.00 TeV.
\vspace{0.5mm}
\item MSTW2008 and MMHT2014 PDF sets provide a large enough range in \alpsmz values and give similar results in full range in \httwot of 0.3 TeV up to 1.68 TeV and for scale variations in this range, and also for subranges in \httwot 
\vspace{0.5mm}
...
\blue{\frac{d\sigma}{d(\httwotns)} = \alpha_S^2(\mur)\hat{X}^{(0)}(\muf,\httwotns)\big[1~\plus \alpha_S(\mur)K1(\mur, \muf,\httwotns)\big]}
 \end{align*}
\item \alpsmz is determined by minimizing the \chisq between the experimental measurements and the theoretical predictions : \\}
\end{itemize}
\vspace{-3mm}
\begin{align*}
\blue{\resizebox{.38\hsize}{!}{$\chsq = M^{T}C^{-1}M,~~~M^{i}= D^{i}-T^{i}$}}
...
\vspace{1mm}
\ball
\item {\scriptsize For the fits of the cross sections, the range in \httwot is restricted to be between 300 GeV and 1 TeV : to avoid the region close to the minimal \pt~threshold of 150 GeV for each jet at low \pt and the onset of electroweak effects at high \pt.\\}
\end{itemize}
\end{frame}
