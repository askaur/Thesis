...
The NP corrections are shown in Figure~\ref{fig:np_factors} for the inclusive 2-jet (top \cmsLeft) and 3-jet event cross sections
(top \cmsRight), as well as for ratio \ratio (bottom). They amount to $\sim$ 5\% for inclusive 2-jet,
...
\begin{center}
  ...
  \caption{Fits to the nonperturbative corrections obtained for
    inclusive 2-jet (top \cmsLeft) and 3-jet (top \cmsRight) event cross
...
for inclusive 2-jet (top \cmsLeft) and 3-jet events (top \cmsRight) and their
...
\begin{center}
  ...
  \caption{Overview of systematic theoretical uncertainties affecting the cross section measurement
    for inclusive 2-jet (top \cmsLeft) and 3-jet events (top \cmsRight) and their ratio \ratio (bottom)
...
\begin{center}
  ...
  \caption{Ratio of data over theory using the CT10 PDF set for
    inclusive 2-jet (top \cmsLeft) and inclusive 3-jet event cross
    sections (top \cmsRight) and their ratio \ratio (bottom). For comparison predictions employing two
